      ...
      <div className="container about-page">
        <div className="text-zone">
          ...
          <p>
            ...
            skills on the fly. Alongside my Javascript skills I have experience
            with MATLAB and Simulink through my university degree.
          </p>
          <p>
            I would describe myself as an adventurous engineer willing to jump
            in the deep end!
          </p>
        </div>
